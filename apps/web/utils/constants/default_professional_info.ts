...
R&B Rastreabilidade Brasil — Junior Front-End Developer
Dec 2021 - Oct 2023 | São Paulo, Brazil
Developed a web application for creating label layouts directly in the browser using Canvas.
Automated ZPL (Zebra Programming Language) generation, reducing creation time and increasing productivity.
Technologies: Angular, Fabric.js, Node.js, ZPL.

Houpa! — Front-End Trainee Developer
Jan 2021 - May 2021
Built reusable React components for e-commerce platforms and responsive landing pages.
Technologies: React, Material UI, Node.js, NestJS.

Education
--
Systems Analysis and Development — Universidade Anhembi Morumbi
Aug 2021 - Dec 2023
...
Technical Skills
--
Front-end: React, Next.js, Angular, Material UI, Tailwind, TypeScript, Styled Components
